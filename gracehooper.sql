...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-04-2020 a las 11:32:57
...
--
-- Base de datos: `gracehooper`
--

CREATE DATABASE `gracehooper`;
-- --------------------------------------------------------
...
(4, 'pepo', 'gonzalo', 'user2.png', 'pesspe@gmail.com', 'Avasdsainguda Mare de Deu de Bellvitge, 10, 08907 Hospitalet de Llobregat, Barcelona', 'Avinguda Mare de Deu de Bellvitge, 10, 08907 Hospitalet de Llobregat, Barcelona', 2, 1, 2),
(5, 'carlos', 'lopez', 'nofoto.jpg', 'carlos@gmail.com', 'Carrer de Mallorca, 401, 08013 Barcelona', NULL, 1, 1, 2),
(6, 'luis', 'martinez', 'nofoto.jpg', 'luis@gmail.com', 'Carrer de Alvar Aalto, 08240 Manresa, Barcelona', NULL, 1, 1, 2),
...
(8, 'admin', 'lknafrnlk', 'nofoto.jpg', 'admin', 'Carrer Major, 4, 17134 La Tallada Emporda, Girona', 'Carrer Major, 4, 17134 La Tallada Emporda, Girona', 1, 1, 1),
...
(11, 'Lauro', 'lopeza', 'nofoto.jpg', 'sdf@KC', 'madrid', 'madrid', 1, 1, 2);
...
(5, 'pp', 'd41d8cd98f00b204e9800998ecf8427e', 6),
(6, 'oo', '08a4415e9d594ff960030b921d42b91e', 7);
...
(1, 'nofoto.jpg', 'admin', 'admin', 'admin', '666666666', 'Barcelona', 2),
(2, 'user1.png', 'Dani', 'Sanchez', 'dani@gmail.com', '683682619', 'Madrid', 2),
(3, 'user2.png', 'Jose', 'Nuevo', 'jose@gmail.com', '654746936', 'Sevilla', 1),
(4, 'user3.jpg', 'pepo', 'Fandos', 'pepeddd@gmail.com', '55655', 'cf', 3),
(5, 'nofoto.jpg', 'carlos', 'carlos', 'carlos@hd', '666666666', 'Cordoba', 1),
(6, 'nofoto.jpg', 'ojÃ sdf', 'pp', 'pp', '666', 'pp', 1),
(7, 'nofoto.jpg', 'ee', 'aa', 'd', '66', 'e', 1);
...
--
ALTER TABLE `contactos`
  MODIFY `id_contactos` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `telefonos`
  MODIFY `id_telefono` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
