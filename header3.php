<div class="header">
	...
	<div class="opciones">
		...
		<div class="opciones2">
			<img src="./imagenes/map.png" class="administrar">
			<a href="mapa_user2.php" class="opcionadmin"> Todos los contactos</a>
		</div>
...
?>
	...
	<div class="menuleft">
		<div class="btnfav"> <a href="#" onclick='consulta("3","1"); return false'><button class="boton5"><b>Mis Contactos</b></button></div></a>

		<div class="btnfav"> <a href="#" onclick='consulta("2","1"); return false'><button class="boton5"><b>Favoritos</b></button></div></a>

		<div class="btnfav"> <a href="#" onclick='consulta("3","3"); return false'><button class="boton5"><b>Eliminados</b></button></div></a>
	</div>
